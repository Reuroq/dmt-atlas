...
PREFIX = 'centre-v34-staged-arithmetic'
HISTORY = 'centre-v34-gl-localization-runtime-integrity.json'
SEEDS = 'centre-v34-followup-seeds.json'
TEXTURE = 'centre-v34-followup-texture.f32'
HTML = 'gpu_centre_v34_staged_arithmetic.html'
...
def gate(prepared=True):
    ...
    assert history['saved_evidence_verified'] and history['actual_exit'] == 1
    if prepared:
...
def receipt(label):
    ...
    assert launch['launcher_sha256'] == digest('run_centre_v34_staged_arithmetic_once.py')
