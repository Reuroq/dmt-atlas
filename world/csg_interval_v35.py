"""Endpoint Taylor enclosures of v35's eleven SMOOTH signed CSG leaves.
...
"""
import numpy as np
from field_centre_v35 import expanded_leaves, compose_expanded
...
def contract_checks():
    """Synthetic crease/negative-sign/union regressions; no v35 field samples."""
    hessian = np.zeros(11)
    ...
    lo, hi = enclosure(a, a, 1., hessian)
    assert lo < 0 < hi
    return {'passed': True, 'synthetic_contracts': 4, 'v35_field_samples': 0}
