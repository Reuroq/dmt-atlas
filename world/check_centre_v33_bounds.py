"""One-shot independent v33 leaf, reach, clearance and footprint samples."""
import hashlib
import json
from pathlib import Path
import numpy as np
from field_centre_v33 import PIXEL,parts,field,analytic_bounds
from fidelity import RENDER_FILES

HERE=Path(__file__).resolve().parent
OUT=HERE/'centre-v33-bounds-check.json'
...
files=['continuum-v33-candidate.js','build_centre_candidate_v33.py','build_centre_v33_checks.py',
    'field_centre_v33.py','centre-v33-bounds.md',Path(__file__).name,
    'gpu_probe_v33_candidate.html','gpu_probe_v33_leaves.html','probe_numeric_candidate_v33.py']
