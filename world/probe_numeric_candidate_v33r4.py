...
from field_centre_v33r4 import field, parts, compose_jets, lower_parts, cheap_parts

HERE = Path(__file__).resolve().parent

def main():
    destination = HERE/'numeric-candidate-v33r4-check.json'
    ...
    with sync_playwright() as p:
        ...
        page.goto((HERE/'gpu_probe_v33r4_candidate.html').as_uri())
        ...
        leaf_page.goto((HERE/'gpu_probe_v33r4_leaves.html').as_uri())
        ...
        browser.close()
    (HERE/'numeric-candidate-v33r4-raw.json').write_text(json.dumps(cases)+'\n')
