...
HTML = PREFIX+'.html'
CANDIDATE = 'continuum-v33r2-candidate.js'
assert not list(HERE.glob(PREFIX+'*')), 'Preserve one-shot evidence'
gate=json.loads((HERE/'centre-v33r2-integrity.json').read_text())
...
html = html.replace('A reported-pattern interpretation', 'ISOLATED v33r2 · synthesised diagnostic')
