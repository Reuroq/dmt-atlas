...
PREFIX='diagnostic-presentation-v18'
assert not list(HERE.glob(PREFIX+'*')) and not (HERE/'trace_presentation_v18.py').exists()
...
change("            after = page.evaluate('journeyDiagnostics()')", "            raw_b,readback_b=canvas_copy()\n            after = page.evaluate('journeyDiagnostics()')")
...
(HERE/'trace_presentation_v18.py').write_text(s)
