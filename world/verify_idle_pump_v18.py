...
from verify import ARGS, diag, next_stage, hold_until, results
from fidelity import render_signature, digest

HERE = Path(__file__).resolve().parent
OUT = HERE / 'verification-idle-pump-v18.json'
assert not OUT.exists(), 'Preserve prior checks'
out = {'render_signature': render_signature(), 'trip_sha256': digest(HERE / 'trip-v18-candidate.js'),
