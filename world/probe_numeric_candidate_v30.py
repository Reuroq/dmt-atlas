...
from field_centre_v30 import field, parts, compose_jets

HERE = Path(__file__).resolve().parent

def main():
    destination = HERE/'numeric-candidate-v30-check.json'
    ...
    with sync_playwright() as p:
        ...
        page.goto((HERE/'gpu_probe_v30_candidate.html').as_uri())
        ...
        browser.close()
    (HERE/'numeric-candidate-v30-raw.json').write_text(json.dumps(cases)+'\n')
