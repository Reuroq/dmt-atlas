...
OUT = HERE / 'centre-v33r5-cost-review.json'
RAW = HERE / 'centre-v33r5-cost-raw.json'
...
for name, key in [('centre-v33r5-bounds-check.json', 'source_hashes'),
                  ('numeric-candidate-v33r5-check.json', 'files'),
                  ('centre-v33r5-first-root-check.json', 'source_hashes')]:
    receipt = read(name)
...
files = ['continuum-v33r3-candidate.js', 'continuum-v33r5-candidate.js',
         'gpu_cost_v33r5_parent.html', 'gpu_cost_v33r5_candidate.html',
         'centre-v33r5-implementation.json', 'centre-v33r5-bounds-check.json',
         'numeric-candidate-v33r5-check.json', 'centre-v33r5-first-root-check.json',
         Path(__file__).name]
...
try:
    with sync_playwright() as p:
        ...
        for arm in ['parent', 'candidate']:
            ...
            page.goto((HERE / f'gpu_cost_v33r5_{arm}.html').as_uri())
            pages[arm] = page
