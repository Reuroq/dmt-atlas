...
OUT = HERE / 'centre-v33r6-cost-review.json'
RAW = HERE / 'centre-v33r6-cost-raw.json'
...
for name, key in [('centre-v33r6-bounds-check.json', 'source_hashes'),
                  ('numeric-candidate-v33r6-check.json', 'files'),
                  ('centre-v33r6-first-root-check.json', 'source_hashes')]:
    receipt = read(name)
...
files = ['continuum-v33r3-candidate.js', 'continuum-v33r6-candidate.js',
         'gpu_cost_v33r6_parent.html', 'gpu_cost_v33r6_candidate.html',
         'centre-v33r6-implementation.json', 'centre-v33r6-bounds-check.json',
         'numeric-candidate-v33r6-check.json', 'centre-v33r6-first-root-check.json',
         'cost_lifecycle_v33r6.py', Path(__file__).name]
...
try:
    with sync_playwright() as p:
        ...
        for arm in ['parent', 'candidate']:
            ...
            page.goto((HERE / f'gpu_cost_v33r6_{arm}.html').as_uri())
            pages[arm] = page
