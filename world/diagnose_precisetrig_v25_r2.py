...
OUT=HERE/'diagnostic-precisetrig-v25-r2.json'
...
with sync_playwright() as p:
    ...
    page.goto((HERE/'diagnostic_precisetrig_v25_r2.html').as_uri())
    for case in cases:
...
out={'method':'Four saved worst-position float32 points, archived GLSL with only sin/cos replaced by range-reduced degree13/12 polynomials, then optional CPU atan override. Live runtime unchanged. No navigation/time/visual acceptance claims.',
     'errors':errors,'cases':results,'sha256':{name:digest(HERE/name) for name in ['continuum.js','continuum-v25.js','trip.js','diagnostic_precisetrig_v25_r2.html','diagnose_precisetrig_v25_r2.py','continuum-v25-numerical-findings.json']}}
