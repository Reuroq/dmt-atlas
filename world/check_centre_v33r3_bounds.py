"""One-shot independent v33r3 leaf, reach, clearance and footprint samples."""
import hashlib
import json
from pathlib import Path
import numpy as np
from field_centre_v33r3 import PIXEL,parts,field,analytic_bounds,lower_parts,cheap_parts
from fidelity import RENDER_FILES

HERE=Path(__file__).resolve().parent
OUT=HERE/'centre-v33r3-bounds-check.json'
...
build=json.loads((HERE/'centre-v33r3-build.json').read_text())
...
t=rng.choice([4.,4.895,8.,221.,900.],n)
eps=.001
results=[]
...
files=['continuum-v33r3-candidate.js','build_centre_v33r3.py','build_centre_v33r3_checks.py',
    'field_centre_v33r3.py','centre-v33r3-bounds.md',Path(__file__).name,
    'gpu_probe_v33r3_candidate.html','gpu_probe_v33r3_leaves.html','probe_numeric_candidate_v33r3.py']
