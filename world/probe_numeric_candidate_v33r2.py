...
from field_centre_v33r2 import field, parts, compose_jets, lower_parts

HERE = Path(__file__).resolve().parent

def main():
    destination = HERE/'numeric-candidate-v33r2-check.json'
    ...
    with sync_playwright() as p:
        ...
        page.goto((HERE/'gpu_probe_v33r2_candidate.html').as_uri())
        ...
        leaf_page.goto((HERE/'gpu_probe_v33r2_leaves.html').as_uri())
        ...
        browser.close()
    (HERE/'numeric-candidate-v33r2-raw.json').write_text(json.dumps(cases)+'\n')
    ...
    for case in cases:
        ...
        summary['passed'] = (lower_scalar_error<.001 and lower_gradient_error<.005 and domination<=0 and summary['misses']==0 and leaf_gradient_error<.005
