...
PREFIX = 'diagnostic-chrysanthemum-v23-material'
...
with sync_playwright() as p:
    ...
    page.goto((HERE/'diagnostic-material-v23.html').as_uri())
    ...
    for label in ['entry', 'deep']:
        ...
        receipt={'diagnostic_only':True, 'file':png.name, 'capture_sha256':digest(png),
                 ...
                 'material_ablation':True, 'max_steps':1024,
                 'limits':'Material isolation only; UI/postprocess still present; no realism credit',
                 'source_hashes':{name:digest(HERE/name) for name in ['continuum.js','continuum-v22.js','diagnostic-material-v23.js','diagnostic-material-v23.html','fractal.js','trip.js']}}
