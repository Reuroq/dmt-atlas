...
def main():
    destination = HERE/'numeric-candidate-v34-check.json'
    ...
    with sync_playwright() as p:
        ...
        page.goto((HERE/'gpu_probe_v34_candidate.html').as_uri())
        ...
        leaf_page.goto((HERE/'gpu_probe_v34_leaves.html').as_uri())
    ...
    out = {'method':'New v34 actual float GLSL rays plus five smooth-base and eleven signed/offset smooth-leaf jets at saved actual roots. Independent float64 scalar/leaf FD; exact float32 CSG selection and original normal replay. Composite FD disagreements retained at creases, not a unique-normal assertion. Original six plus central3x3 dense .003 first-crossing references, even/odd grids, HIGH/LOW, entry/deep, times2.4077/3.5242/4/4.895/8/221/900. Sampled evidence only; no universal convergence, filtering, realism or performance proof.',
           'limits':{'gradient':.005,'bound_ratio':1.001,'scalar':.001,'root':.03},
           'files':{name:digest(HERE/name) for name in ['continuum.js','trip.js','continuum-v25.js','continuum-v34-candidate.js','build_centre_v34.py','centre-v34-bound-design.json','centre-v34-fixture-integrity.json','gpu_csg_v34.py','runtime_centre_v34.py','cost_lifecycle_v34.py','centre-v34-bounds-check.json','centre-v34-gpu-started.json','gpu_probe_v34_leaves.html','gpu_probe_v34_candidate.html','probe_numeric_candidate_v34.py','field_centre_v34.py','numeric-candidate-v34-raw.json']},
