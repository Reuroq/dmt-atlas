"""One-shot independent v33r2 leaf, reach, clearance and footprint samples."""
import hashlib
import json
from pathlib import Path
import numpy as np
from field_centre_v33r2 import PIXEL,parts,field,analytic_bounds,lower_parts
from fidelity import RENDER_FILES

HERE=Path(__file__).resolve().parent
OUT=HERE/'centre-v33r2-bounds-check.json'
...
files=['continuum-v33r2-candidate.js','build_centre_v33r2.py','build_centre_v33r2_checks.py',
    'field_centre_v33r2.py','centre-v33r2-bounds.md',Path(__file__).name,
    'gpu_probe_v33r2_candidate.html','gpu_probe_v33r2_leaves.html','probe_numeric_candidate_v33r2.py']
