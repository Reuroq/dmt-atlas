...
with sync_playwright() as p:
    ...
    page.goto((HERE / 'diagnostic-presentation-v18r2.html').as_uri())
    ...
    if args.check_stillness:
        def frozen(label):
            ...
            # Read-only copy of the browser canvas AFTER the first screenshot.
    ...
    def capture(label):
        ...
        # Isolated diagnostic: do not overwrite the default display.
    ...
    # Isolated diagnostic: leave full-size default captures unchanged.
