...
PREFIX = 'diagnostic-centre-v33r4'
HTML = PREFIX+'.html'
CANDIDATE = 'continuum-v33r4-candidate.js'
assert not list(HERE.glob(PREFIX+'*')), 'Preserve one-shot evidence'
gate=json.loads((HERE/'centre-v33r4-integrity.json').read_text())
...
html = html.replace('A reported-pattern interpretation', 'ISOLATED v33r4 · synthesised diagnostic')
