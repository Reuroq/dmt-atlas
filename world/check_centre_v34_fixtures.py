...
def check():
    ...
    assert candidate.count(edit['old']) == reference.count(edit['new']) == 1
    assert reference.replace(edit['new'],edit['old'],1) == candidate
...
'''
    ...
    assert shaders['gpu_cost_v34_parent.html'].replace(edit['new'],edit['old'],1) == shaders['gpu_cost_v34_candidate.html']
