...
from canonical_runtime_v35r3 import (HERE, MANIFEST, artifact, read, digest, atomic_json,
    worker, stage_receipt, expected_keys, bijection, require, verify)
from canonical_evidence_v35r3 import (numeric_assessment, joined_inputs, validate_local,
