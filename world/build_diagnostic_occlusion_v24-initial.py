...
renderer = renderer.replace("'continuum-v22.js'", "'continuum-v23.js','trip-v16.js','render_diagnostic_occlusion_v24.py','build_diagnostic_occlusion_v24.py','index.html','data.js','sources.js','vendor/three.min.js'")
...
runtime = ['continuum.js','trip.js','fractal.js','index.html','sources.js','data.js']
