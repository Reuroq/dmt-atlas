...
from canonical_history_v35r3 import HISTORY, UPSTREAM, verify_history
import additive_runtime_v35r2 as old
STAGES = ('global', 'combination')
SCRIPTS = {'global': 'global_canonical_v35r3.py', 'combination': 'combine_canonical_v35r3.py'}
READY = {'global': 'global_roots_passed', 'combination': 'numeric_passed'}
...
def static_receipt(label):
    ...
    require(launch['script_sha256'] == digest('prepare_canonical_v35r3.py'))
    require(launch['launcher_sha256'] == digest('run_canonical_static_v35r3_once.py'))
    if label == 'close':
...
def stage_receipt(stage):
    ...
    require(launch['launcher_sha256'] == digest('run_canonical_v35r3_once.py'))
