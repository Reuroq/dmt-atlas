...
from cost_lifecycle_v34 import Lifecycle, CostSignal, install_signal_receipts, restore_signals
...
def check():
    checks = []
    with tempfile.TemporaryDirectory(prefix='v34-lifecycle-check-', dir=HERE) as temp:
        directory = Path(temp)
