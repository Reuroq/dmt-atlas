...
PREFIX = 'diagnostic-centre-v35'
HTML = PREFIX+'.html'
CANDIDATE = 'continuum-v35-candidate.js'
assert not list(HERE.glob(PREFIX+'*')), 'Preserve one-shot evidence'
gate=json.loads((HERE/'centre-v35-integrity.json').read_text())
...
html = html.replace('A reported-pattern interpretation', 'ISOLATED v35 · synthesised diagnostic')
