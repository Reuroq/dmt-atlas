...
PREFIX = 'diagnostic-chrysanthemum-v23'
...
with sync_playwright() as p:
    ...
    page.goto((HERE/'diagnostic-continuum-v23.html').as_uri())
    ...
    for label in ['entry', 'deep']:
        ...
        receipt={'diagnostic_only':True, 'file':png.name, 'capture_sha256':digest(png),
                 ...
                 'root_delta_tolerance':.002, 'reference_max_steps':4096,
                 'limits':'CPU/GPU float comparison, not proof; UI/postprocess still present; no realism credit',
                 'source_hashes':{name:digest(HERE/name) for name in ['continuum.js','continuum-v22.js','diagnostic-continuum-v23.js','diagnostic-continuum-v23.html','fractal.js','trip.js']}}
