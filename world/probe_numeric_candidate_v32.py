...
from field_centre_v32 import field, parts, compose_jets

HERE = Path(__file__).resolve().parent

def main():
    destination = HERE/'numeric-candidate-v32-check.json'
    ...
    with sync_playwright() as p:
        ...
        page.goto((HERE/'gpu_probe_v32_candidate.html').as_uri())
        ...
        leaf_page.goto((HERE/'gpu_probe_v32_leaves.html').as_uri())
        ...
        browser.close()
    (HERE/'numeric-candidate-v32-raw.json').write_text(json.dumps(cases)+'\n')
